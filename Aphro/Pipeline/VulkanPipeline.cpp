...
namespace aph {
	...
	VulkanPipeline::VulkanPipeline(
		...
		createGraphicsPipeline(vert_path, frag_path, configInfo);
	}
	...
	std::vector<char> VulkanPipeline::readFile(const std::string& filepath) {
		...
		//std::cout << futils::getExecutablePath() << '\n';
		if (!file.is_open()) {
	...
	void VulkanPipeline::createGraphicsPipeline(const std::string& vert_file, const std::string& frag_file, const PipelineConfigInfo& configInfo) {
		assert(
